...
USE spacy;
CREATE TABLE unimplemented(sentence varchar(250), guess varchar(250), sort varchar(10), id smallint unsigned not null auto_increment, constraint pk_example primary key (id));
